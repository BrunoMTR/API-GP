...
namespace Domain.Services
{
    public interface IProcessService
    {
        ...
        Task<Response<List<DocumentationDto>>> GetAllDocumentationsAsync(Query query);
        ...
        Task<Response<ProcessDto>> CancelAsync(int processId, string updatedBy, string? note);

        Task<Response<ProcessDto>> ReturnAsync(int processId, string updatedBy, string? note);
